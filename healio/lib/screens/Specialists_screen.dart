...
const List<Map<String, dynamic>> kSpecialistData = [
  ...
  {'name': 'Neurologist',        'icon': Icons.psychology_rounded,            'color': 0xFF7C83E8},
  ...
  {'name': 'Gynecologist',       'icon': Icons.pregnant_woman_rounded,        'color': 0xFFEC407A},
  {'name': 'Pulmonologist',      'icon': Icons.air_rounded,                   'color': 0xFF26C6DA},
  {'name': 'Gastroenterologist', 'icon': Icons.local_dining_rounded,          'color': 0xFFFF7043},
  {'name': 'Endocrinologist',    'icon': Icons.science_rounded,               'color': 0xFF9C27B0},
  {'name': 'Ophthalmologist',    'icon': Icons.visibility_rounded,            'color': 0xFF1E88E5},
  {'name': 'Psychiatrist',       'icon': Icons.self_improvement_rounded,      'color': 0xFF00897B},
  {'name': 'Urologist',          'icon': Icons.water_drop_rounded,            'color': 0xFF039BE5},
  {'name': 'Oncologist',         'icon': Icons.biotech_rounded,               'color': 0xFF6D4C41},
