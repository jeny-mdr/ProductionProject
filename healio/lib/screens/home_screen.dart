  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                    ...
                    children: [
                      if (role == 'doctor') ...[
                        ...
                        _ActionCard(
                          ...
                          iconBg: HealioColors.accentLight,
                          onTap: () => Navigator.pushNamed(
                              context, '/profile'),
                        ),
                      ] else ...[
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (i) {
          if (role == 'doctor') {
            if (i == 1) Navigator.pushNamed(context, '/appointments');
            if (i == 2) Navigator.pushNamed(context, '/chats');
            if (i == 3) Navigator.pushNamed(context, '/profile');
          } else {
            if (i == 1) Navigator.pushNamed(context, '/specialists');
            if (i == 2) Navigator.pushNamed(context, '/chats');
            if (i == 3) Navigator.pushNamed(context, '/profile');
          }
        },
