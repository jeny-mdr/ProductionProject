...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _fetchPending() async {
    ...
    try {
      ...
      if (res.statusCode == 200) {
        final appointments =
        List<dynamic>.from(jsonDecode(res.body));
  ...
  Widget build(BuildContext context) {
    ...
    final name = user?['username'] ?? 'Friend';
                    ...
                    children: [
                      if (role == 'doctor') ...[
                        _ActionCard(
                          ...
                          label: 'My\nAppointments',
                          color: const Color(0xFF7C83E8),
                          iconBg: const Color(0xFFEEEFFC),
                        ...
                        _ActionCard(
                          ...
                          label: 'Nearby\nHospitals',
                          color: HealioColors.primary,
                          iconBg: HealioColors.primaryLight,
                          onTap: () => Navigator.pushNamed(
                              context, '/hospitals'),
                        ),
                        _ActionCard(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (i) async {
          if (i == 0) {
            ...
            if (i == 2)
              await Navigator.pushNamed(context, '/chats');
            if (i == 3)
            ...
            if (i == 1)
              await Navigator.pushNamed(context, '/specialists');
            if (i == 2)
              await Navigator.pushNamed(context, '/chats');
            if (i == 3)
              await Navigator.pushNamed(context, '/profile');
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: Text('Cancel',
                style:
                GoogleFonts.poppins(color: HealioColors.textMid)),
          ),
          TextButton(
            onPressed: () {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: HealioColors.primary.withOpacity(0.08),
            blurRadius: 12,
            offset: const Offset(0, 4),
          ),
        ],
